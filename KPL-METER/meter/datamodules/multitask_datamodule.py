...
# from ..datasets.report_generation_dataset import REPORT_GENERATION_Dataset
...
class MTDataModule(LightningDataModule):
    def __init__(self, _config, dist=False):
        ...
        self.num_batch_multi = _config["num_batch_multi"]
    ...
    def val_dataloader(self, batch_size=None):
        loader = DataLoader(
            self.val_dataset,
            batch_size=int(self.batch_size*self.num_batch_multi),#(batch_size if batch_size is not None else self.batch_size)*2,
    ...
    def test_dataloader(self):
        loader = DataLoader(
            self.test_dataset,
            batch_size=int(self.batch_size*self.num_batch_multi),#(self.batch_size)*2,
