...
class VQAMEDVQA2019Dataset(BaseDataset):
    def __init__(self, *args, split="", **kwargs):
        ...
        if split == "train":
            names = ["vqa_medvqa_2019_entity_train"]#["vqa_medvqa_2019_train"]
        elif split == "val":
            names = ["vqa_medvqa_2019_entity_val"]#["vqa_medvqa_2019_val"]
        elif split == "test":
            names = ["vqa_medvqa_2019_entity_test"]#["vqa_medvqa_2019_test"]
