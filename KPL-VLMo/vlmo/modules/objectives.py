        ...
        text_preload.append(
            {
                ...
                "prompt_text": _b["prompt_text_ids"].to(pl_module.device),
                "prompt_text_masks": _b["prompt_text_masks"].to(pl_module.device),
            }
        )
            ...
            cls_feats = pl_module.infer_text_ft(
                    {
                        ...
                        "prompt_str_ids": txt_batch["prompt_text"],
                        "prompt_text_masks": txt_batch["prompt_text_masks"],
                    }
                )["cls_feats"]
