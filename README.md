...
## Prepare data
- We follow the M3AE framework to prepare data in Arrow format. Please refer to the [M3AE](https://github.com/zhjohnchan/M3AE/blob/master/prepro/prepro_finetuning_data.py) for detailed instructions.
- Merge Knolwedge description to Arrow file using `merge_knowledge2arrow.py`
...
```
## Acknowledgements
We would like thanks to [METER](https://github.com/zdou0830/METER), [M3AE](https://github.com/zhjohnchan/M3AE), [ViLT](https://github.com/dandelin/ViLT) for their open-source contributions.
